...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\porndetection on
     Windows, /home/user/dev/porndetection on Linux) in a file named
     porndetection@nuarlyss.wordpress.com and copy that file to
